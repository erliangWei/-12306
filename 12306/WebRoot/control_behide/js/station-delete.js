...
function deleteStation(){				//删除数据
	var tab=document.getElementById("station_list");		//获取要删除数据表格元素
	var rows=tab.rows;										//获取删除行
	var stationId;						//定义变量，用来获取删除记录的列车代码
	var kkk='';
	...
	if(kkk!=''){
		$.ajax({			//调用action
            url:"/12306/delectStation.action",
            data:{"delStatioId":kkk},
            type:"post",
